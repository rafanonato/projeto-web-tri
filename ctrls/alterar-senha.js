...
app.controller('alterarSenhaCtrl', ['$scope', '$window', '$http', '$q', '$location', '$route', 'requests', 'envService',
function alterarSenhaCtrl($scope, $window, $http, $q, $location, $route, requests, envService) {
